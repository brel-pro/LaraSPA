...
class MakeAdminModuleCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laraspa:adminModule {name}';
     ...
     * @var string
     */
    protected $description = 'Create a new Module for front-end and back-end (admin SPA)';
    ...
    public function handle(Filesystem $files, MakeFrontEndModule $frontEndModule, MakeBackEndModule $backEndModule)
    {
        ...
        $frontEndModule->createAdminModule($this->module);
